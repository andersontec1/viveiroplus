...
class _TelaDetalhesBercarioState extends State<TelaDetalhesBercario> with SingleTickerProviderStateMixin {
      ...
      return Container(
        ...
        child: Row(
          children: [
            ...
            Text(valor, style: TextStyle(color: Colors.green.shade900, fontWeight: FontWeight.w600)),
          ],
        ),
      );
    }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.spa, color: Colors.green, size: 32),
          ...
          children: [
            ...
            if (fora && ideal != null)
              Padding(
                ...
                child: Text('(Ideal: $ideal)', style: const TextStyle(color: Colors.green, fontSize: 12)),
              ),
          ],
        ),
      );
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          const Icon(Icons.restaurant, color: Colors.green, size: 18),
                          const SizedBox(width: 6),
                          Text('Quantidade fornecida: ', style: const TextStyle(fontWeight: FontWeight.bold)),
                          Text('${quantidade} kg', style: TextStyle(color: Colors.green.shade900, fontWeight: FontWeight.w600)),
                        ],
                      ),
                    ),
