...
DateTime? _validade;
final List<String> _unidades = ['kg', 'g', 'L', 'mL', 'saco', 'un', 'caixa', 'outro'];
  ...
  Future<void> _salvarInsumo() async {
    ...
    final dados = {
      ...
      'quantidade_inicial': double.tryParse(_quantidadeInicialController.text.replaceAll(',', '.')) ?? 0,
    };
  ...
  void _carregarParaEdicaoDocId(String docId, Map<String, dynamic> data) {
    setState(() {
      ...
      _quantidadeInicialController.text = data['quantidade_inicial']?.toString() ?? '';
            ...
            children: [
              Row(
                children: [
                  Expanded(
                    child: Text(
                      _idEditando == null ? 'Cadastrar novo insumo' : 'Editar insumo',
                      style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500),
                    ),
                  ),
                  ElevatedButton.icon(
                    icon: Icon(_mostrarFormulario ? Icons.close : Icons.add),
                    label: Text(_mostrarFormulario ? 'Fechar' : (_idEditando == null ? 'Novo Insumo' : 'Editar')),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _mostrarFormulario ? Colors.red[200] : Colors.teal,
                    ),
                    onPressed: () {
                      setState(() {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                              ...
                              children: [
                                Expanded(
                                  child: DropdownButtonFormField<String>(
                                    ...
                                    onChanged: (val) => setState(() => _unidadeController.text = val ?? ''),
                            ...
                            const SizedBox(height: 12),
                            ElevatedButton.icon(
                              icon: Icon(_idEditando == null ? Icons.save : Icons.edit),
                              label: Text(_idEditando == null ? 'Salvar' : 'Atualizar'),
              ...
              const Text('Insumos Cadastrados', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final docs = snapshot.data!.docs.where((doc) {
                      ...
                      return nome.contains(_busca.toLowerCase()) || categoria.contains(_busca.toLowerCase());
                    }).toList();
                    if (docs.isEmpty) return const Center(child: Text('Nenhum insumo cadastrado.'));
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  padding: const EdgeInsets.all(12),
                                  child: Icon(Icons.inventory_2_rounded, color: baixo ? Colors.red : Colors.teal, size: 32),
                                ),
                                ...
                                Column(
                                  ...
                                  children: [
                                    PopupMenuButton(
                                      onSelected: (value) {
                                        if (value == 'detalhes') {
                                          _mostrarDetalhesInsumo(data, insumo.id);
                                        } else if (value == 'editar') {
                                          _carregarParaEdicaoDocId(insumo.id, data);
                                      ...
                                      itemBuilder: (context) => [
                                        ...
                                        const PopupMenuItem(
                                          ...
                                          child: ListTile(
                                            ...
                                            title: Text('Editar', style: TextStyle(color: Colors.teal)),
                                          ),
                                        ),
                                        const PopupMenuItem(
                                          value: 'excluir',
