...
class DestinosCache {
  ...
  static Future<Map<String,String>> obterViveiros() async { await _carregarSeNecessario(); return Map.unmodifiable(_viveiros!); }
  static Future<Map<String,String>> obterBercarios() async { await _carregarSeNecessario(); return Map.unmodifiable(_bercarios!); }
  static void limpar(){ _viveiros=null; _bercarios=null; _ultimoFetch=null; }
}
